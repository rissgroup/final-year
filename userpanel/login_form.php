			<form id="login_form1" class="form-signin" method="post">
						...
						<button data-placement="right" style="background-color:black; color:white;"title="Click Here to Sign In" id="signin" name="login" class=" " type="submit"><i class="icon-signin icon-large"></i> Sign in</button>
			...
			New to Online Learning & Earning
			<hr>
